...
export const CASH_OUTFLOW_AUDIT_FIELDS: Record<string, AuditFieldMeta> = {
  ...
  hotelOperatingType: { label: "Operating Segment", uiStep: 4, type: "select" },
  hotelStarRating: { label: "Market Positioning", uiStep: 4, type: "select" },
  retailSegment: { label: "Operating Segment", uiStep: 4, type: "select" },
  retailPositioning: { label: "Market Positioning", uiStep: 4, type: "select" },
  officeSegment: { label: "Operating Segment", uiStep: 4, type: "select" },
  ...
  basements: { label: "Basements", uiStep: 5, type: "input" },
  podiumFloors: { label: "Podium / Parking Floors", uiStep: 5, type: "input" },
  towerFloors: { label: "Building Floors", uiStep: 5, type: "input" },
