...
- Sale cash-flow column count is Construction Period plus the selected escrow-rule offset: Progress Drawdown +24 months, Staged Escrow and 10/90 +12, No Escrow +6. Location + asset class only pre-select a default (Australia → 10/90 all classes; Dubai/UAE → Staged all classes; Malaysia → Progress residential / No Escrow commercial; all other locations → none). All four rules remain selectable. Unset mode must not silently inherit staged/UAE escrow logic.
