...
export default function WarehouseOperationalPnLSlide({
  data,
  commentary,
  isEditing = false,
  onParagraphChange,
  ...
  const defaultCommentary = `The warehouse / logistics asset demonstrates operational leverage, with EBITDA margins moving from ${y1EbitdaMargin} in Year 1 to a stabilized ${y3EbitdaMargin} by Year 3 as occupancy and lease rates mature. Post-stabilization, the asset is projected to deliver consistent operating cash generation that supports overall project return metrics.`;
      ...
      <div className="flex-1 min-h-0 overflow-hidden">
        <table className="w-full text-[8px] border-collapse border border-slate-300 text-slate-900">
          ...
          <tbody>
            ...
            <PnlLineRow label="Base Rent & Yard" values={data.revenues.officeRent} revTotal={revGrandTotal} indent />
            <PnlLineRow label="CAM / Tax / Insurance Recoveries" values={data.revenues.camRecoveries} revTotal={revGrandTotal} indent />
            ...
            <PnlLineRow
              label="Maintenance, Utilities & Security"
