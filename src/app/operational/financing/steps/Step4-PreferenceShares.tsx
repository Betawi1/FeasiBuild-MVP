      ...
      {prefSharesEnabled ? (
        <div className="space-y-6 rounded-xl border border-slate-700/50 bg-slate-800/30 p-6">
          <div className="rounded-lg border border-slate-700 bg-slate-900/50 p-4">
            ...
            <p className="mt-1 text-[10px] text-slate-500">From Component 4 Step 3</p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div>
              ...
              <div className="mt-1 flex justify-between text-xs text-slate-500">
                <span>0%</span>
                <span className="font-bold text-white">{prefSharesAllocationPercent}%</span>
                <span>100%</span>
              </div>
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div>
              ...
              >
                ...
                <option value="islamic-profit">Islamic target profit (% p.a.)</option>
              </select>
            </div>
          </div>
        ...
        <div className="rounded-xl border border-dashed border-slate-700 p-8 text-center text-slate-500">
          Preference shares are disabled. 100% of residual cash equity will be treated as
          common equity.
        </div>
      )}
    </div>
